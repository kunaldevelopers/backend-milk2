...
=======
    const { username, password, name, contactNumber, location, shift } =
      req.body;
    const validShifts = (await getSetting("validShifts")) || ["AM", "PM"];

    // Use environment variables for default role
...
=======
    // Use environment variable for default shift
    const staffShift = shift || config.defaultShift;
>>>>>>> d0d9e6c94d1455a154b337c416cd476000f0087c
